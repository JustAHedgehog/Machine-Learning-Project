...
# 查詢 Chroma 資料庫
query_results = collection.query(query_embeddings=query_embeddings, n_results=1)

#for doc, meta, dist in zip(query_results['documents'], query_results['metadatas'], query_results['distances']):
#    print("Meta:", meta)  # 打印 meta 查看其结构
