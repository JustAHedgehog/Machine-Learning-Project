...
def get_query(temperature:int, body_temp:int, humidity:int, gender:str, zone:str, pipeline:Pipeline, collection:chromadb.types.Collection):
    query_data = {
        '現在穿著本套衣服時的溫度(°C)': [temperature],
...
if __name__ == "__main__":
    ...
    query_results = get_query(22,21,60,'男','室內',pipeline, collection)
